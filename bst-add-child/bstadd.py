...
class Node(object):
    ...
    def insert(self, new_data):
        ...
        if new_data >= self.data and self.right:
            self.right.insert(new_data)

        elif new_data >= self.data and not self.right:
            self.right = Node(new_data)

        elif new_data < self.data and self.left:
            self.left.insert(new_data)

        elif new_data < self.data and not self.left:
